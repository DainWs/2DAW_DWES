                ...
                <main>
                    <form class="grid-div " action="<?= $_SERVER['APP_BASE_URL'] . '/UsuariosController/doEditUserPost'; ?>" enctype="application/x-www-form-urlencoded" method="POST" autocomplete="off">
                        <div class="grid-name">
                            ...
                            <input id="user-name" type="text" name="name" placeholder="<?= $DATA[ViewConstants::SESSION_USER]->nombre ?? '' ?>" value="" autocomplete="new-name"/><br />
                        ...
                        <div class="grid-surname">
                            ...
                            <input id="user-surname" type="text" name="surname" placeholder="<?= $DATA[ViewConstants::SESSION_USER]->apellidos ?? '' ?>" value="" autocomplete="new-surname"/><br />
                        </div>

                        <div class="grid-email">
                            <label for="user-email">Email:</label><br />
                            <input id="user-password" type="text" name="email" placeholder="<?= $DATA[ViewConstants::SESSION_USER]->email ?? '' ?>" value="" autocomplete="new-email"/><br />
                        ...
                        <div class="grid-rol">
                            ...
                            <p><?= $DATA[ViewConstants::SESSION_USER]->rol ?></p>
                        </div>
